...
function openerquizz(wa1, wa2, wa3, wa4, ra1, ra2, ra3, ra4, qmTense) {
    ...
    // утв форма
    const fakeFutureCntFormula1 = `${S} ${BeFuture} ${V1}`
    const fakeFutureCntFormula2 = `${S} ${Ving}`
    const fakeFutureCntFormula3 = `${S} ${BeFuture} ${V1}`
    const fakeFutureCntFormula4 = `${S} WILL ${Ving}`
    const futurecontinuousformula = `${S} ${BeFuture} ${Ving}`


    // вопр форма
    const fakeFutureCntFormula1Q = `${S} ${BeFuture} ${Ving} ?`
    const fakeFutureCntFormula2Q = `WILL ${S} BE ${V1} ?`
    const fakeFutureCntFormula3Q = `${S} ${BeFuture} ${Ving} ?`
    const fakeFutureCntFormula4Q = `WILL ${S} ${Ving} ?`
    const futurecontinuousformulaq = `WILL ${S} BE ${Ving} ?`


    //отр форма
    const fakeFutureCntFormula1N = `${S} ${BeFuture} NOT ${Ving}`
    const fakeFutureCntFormula2N = `${S} WILL NOT ${Ving}`
    const fakeFutureCntFormula3N = `${S} WILL NOT BE ${V1}`
    const fakeFutureCntFormula4N = `${S} ${BeFuture} NOT ${Ving}`
    ...
    //was were
    const amareisquestion = `${S} (BE) ${Ving} ${objectCntnVerb} ${timeFutureSpecial}`
    const amareisAnswerFake1 = `WILL`
    const amareisAnswerFake2 = `${BePresent}`
    const amareisAnswerFake3 = `${BePast}`
    const amareisAnswerFake4 = `${BePresentFake}`
    const amareisAnswer = `${BeFuture}`
